        ...
        <main className="container dashboard-container">
            <div className='container '>
                ...
                <div className='grid'>
                    ...
                    <div className='dashboard-graphs'>
                        <iframe src="http://34.245.209.91:3000/d-solo/adfgkoaumt5ogd/pir-sensor-data?orgId=1&from=1709745753460&to=1709775749123&panelId=1" width="100%" height="200px" frameBorder="0"></iframe>
